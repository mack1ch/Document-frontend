...
export const NakladnayaCreate = () => {
    ...
    useEffect(() => {
        if (
            ...
            inputValues.provider_INN.length > 0 &&
            inputValues.provider_KPP.length > 0 &&
        ...
        inputValues.provider_INN.length,
        inputValues.provider_KPP.length,
                ...
                <main className={styles.layout}>
                    <div className={styles.card}>
                        <dl className={styles.line}>
                            <span className={styles.line__title}>Накладная №</span>
                            <Input
                        ...
                        <dl className={styles.table}>
                            ...
                            <div className={styles.table__line}>
                                <h3 className={styles.table__line_title}>Поставщик:</h3>
                                <dt className={styles.line}>
                                    <span className={styles.line__title}>ИНН</span>
                                    <Input
                                        onChange={handleInputChange}
                                        name="provider_INN"
                                        value={inputValues.provider_INN}
                                        placeholder="Текст"
                                        type="number"
                                    />
                                </dt>
                                <dt className={styles.line}>
                                    ...
                                    <Input
                                        onChange={handleInputChange}
                                        name="provider_KPP"
                                        value={inputValues.provider_KPP}
                                        placeholder="Текст"
                                        type="number"
                                    />
                                </dt>
                            ...
                            <div className={styles.table__line}>
                                <h3 className={styles.table__line_title}>Плательщик:</h3>
                                <dt className={styles.line}>
                                    <span className={styles.line__title}>ИНН</span>
                                    <Input
                                        onChange={handleInputChange}
                                        name="payer_INN"
                                        value={inputValues.payer_INN}
                                        placeholder="Текст"
                                        type="number"
                                    />
                                </dt>
                        ...
                        <dl className={styles.data__wrap}>
                            ...
                            <div className={styles.data__line}>
                                <h3 className={styles.line__title}>Поставщик и его адрес:</h3>
                                <span className={styles.data}>
                                    Фармдистрибьютор “Гигант” 620014, Свердловская область,
                                    Екатеринбург, Шейнкмана, 73
                                </span>
                            ...
                            <div className={styles.data__line}>
                                <h3 className={styles.line__title}>Плательщик и его адрес:</h3>
                                <span className={styles.data}>
                                    Фармдистрибьютор “Гигант” 620014, Свердловская область,
                                    Екатеринбург, Шейнкмана, 73
                                </span>
